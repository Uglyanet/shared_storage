...
var LocalStorageManager = /*#__PURE__*/_createClass(function LocalStorageManager() {
  _classCallCheck(this, LocalStorageManager);
});
_defineProperty(LocalStorageManager, "init", function () {
...
_defineProperty(LocalStorageManager, "updateValueByKey", function (key, newValue) {
  localStorage.setItem(getFullKey(key), JSON.stringify(newValue));
});
_defineProperty(LocalStorageManager, "getValueByKey", function (key) {
...
var ReduxContext = /*#__PURE__*/React.createContext("redux");
    ...
    var Connect = /*#__PURE__*/function (_React$Component) {
      ...
      _createClass(Connect, [{
        ...
        value: function render() {
          ...
          return /*#__PURE__*/React.createElement(Component, _extends({}, this.props, mapStateToProps(store.getState()), mapDispatchToProps(store.dispatch)));
        }
      }]);
      return Connect;
    }(React.Component);
    return function (props) {
      return /*#__PURE__*/React.createElement(ReduxContext.Consumer, null, function (store) {
